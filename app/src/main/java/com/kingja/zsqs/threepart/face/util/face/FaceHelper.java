package com.kingja.zsqs.threepart.face.util.face;
...
import com.kingja.zsqs.threepart.face.util.TrackUtil;
...
public class FaceHelper {
     ...
     */
    public void requestFaceLiveness(byte[] nv21, FaceInfo faceInfo, int width, int height, int format,
                                    Integer trackId, LivenessType livenessType) {
        if (faceListener != null) {
    ...
    public class FaceLivenessDetectRunnable implements Runnable {
        ...
        private FaceLivenessDetectRunnable(byte[] nv21Data, FaceInfo faceInfo, int width, int height, int format,
                                           Integer trackId, LivenessType livenessType) {
            if (nv21Data == null) {
                return;
            }
                ...
                if (flEngine != null) {
                    ...
                    synchronized (flEngine) {
                        if (livenessType == LivenessType.RGB) {
                            ...
                            flCode = flEngine.processIr(nv21Data, width, height, format, Arrays.asList(faceInfo),
