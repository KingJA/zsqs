...
import com.kingja.zsqs.threepart.face.model.FacePreviewInfo;
import com.kingja.zsqs.threepart.face.util.camera.CameraHelper;
import com.kingja.zsqs.threepart.face.util.camera.CameraListener;
import com.kingja.zsqs.threepart.face.util.face.FaceHelper;
import com.kingja.zsqs.threepart.face.util.face.FaceListener;
import com.kingja.zsqs.threepart.face.util.face.LivenessType;
import com.kingja.zsqs.threepart.face.util.face.RecognizeColor;
...
public class FaceSir {
    ...
    private OnRegisterFaceListener onRegisterFaceListener;
    ...
    public void initEngineAndCamera(FaceRectView faceRectView, TextureView previewView,
                                    ...
                                    OnRegisterFaceListener onRegisterFaceListener) {
        this.faceRectView = faceRectView;
        this.previewView = previewView;
        this.onSearchFaceListener = onSearchFaceListener;
        this.onRegisterFaceListener = onRegisterFaceListener;
        initEngine();
        initCamera();
    }
...
//                                adapter.notifyItemInserted(compareResultList.size() - 1);
    ...
    public interface OnRegisterFaceListener {
        void onRegisterFaceCheck(Bitmap faceBitmap, FaceFeature faceFeature, String username);

        void onRegisterFaceSuccess(String username);

        void onRegisterFaceFail(Throwable e);
    }
...
//                    adapter.notifyItemRemoved(i);
    ...
    private void registerFace(final byte[] nv21, final List<FacePreviewInfo> facePreviewInfoList) {
        if (registerStatus == REGISTER_STATUS_READY && facePreviewInfoList != null && facePreviewInfoList.size() > 0) {
            ...
            if (onRegisterFaceListener != null) {
                ...
                Bitmap faceBitmap = FaceServer.getInstance().getPreviewFaceBitmap(nv21.clone(),
                        previewSize.width, previewSize.height, faceInfo.getRect(), faceInfo.getOrient());
                FaceFeature faceFeature = FaceServer.getInstance().getFaceFeature(context, nv21, previewSize.width,
                        previewSize.height, faceInfo);

                onRegisterFaceListener.onRegisterFaceCheck(faceBitmap, faceFeature, username);
            }
    ...
    public void doRegister(Bitmap faceBitmap, FaceFeature faceFeature, String username) {
        Observable.create(new ObservableOnSubscribe<Boolean>() {
            @Override
            public void subscribe(ObservableEmitter<Boolean> emitter) {
                boolean success = FaceServer.getInstance().registerUser(context, faceBitmap, faceFeature, username);
                ...
                .subscribe(new Observer<Boolean>() {
                    ...
                    public void onNext(Boolean success) {
                        ...
                        if (onRegisterFaceListener != null) {
                            onRegisterFaceListener.onRegisterFaceSuccess(username);
                        }
                        registerStatus = REGISTER_STATUS_DONE;
                    }
                    ...
                    public void onError(Throwable e) {
                        e.printStackTrace();
                        if (onRegisterFaceListener != null) {
                            onRegisterFaceListener.onRegisterFaceFail(e);
                        }
