 ...
 */
public class ProjectIdConfigActivity extends BaseActivity implements ProjectInfoContract.View {
    ...
    public void activeEngine() {
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) {
                ...
                int activeCode = FaceEngine.activeOnline(ProjectIdConfigActivity.this, Constants.APP_ID, Constants.SDK_KEY);
                ...
                .subscribe(new Observer<Integer>() {
                    ...
                    public void onNext(Integer activeCode) {
                        ...
                        int res = FaceEngine.getActiveFileInfo(ProjectIdConfigActivity.this, activeFileInfo);
    ...
    public void onGetProjectInfoSuccess(ProjectBaseInfo projectBaseInfo) {
        ...
        confirmDialog.setOnConfirmListener(new BaseTimerDialog.OnConfirmListener() {
            ...
            public void onConfirm() {
                ...
                GoUtil.goActivityAndFinish(ProjectIdConfigActivity.this, MainActivity.class);
