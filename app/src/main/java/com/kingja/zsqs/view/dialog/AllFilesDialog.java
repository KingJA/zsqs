 ...
 */
public class AllFilesDialog extends BaseTimerDialog {
    ...
    public static AllFilesDialog newInstance(List<? extends IFile> fileList) {
        AllFilesDialog fragment = new AllFilesDialog();
