 ...
 */
public class DialogDoubleFragment extends BaseDialogFragment {
    ...
    public static DialogDoubleFragment newInstance(String content, String confirmText) {
        DialogDoubleFragment fragment = new DialogDoubleFragment();
